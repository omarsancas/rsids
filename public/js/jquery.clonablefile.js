...
$(document).ready(function(){
    ...
    $('#clonetriggerfile').click(function(){
        var yourclass=".clonablefile";  //The class you have used in your form
        ...
        $(yourclass+":first").fieldclone({		//Clone the original elelement
            ...
            target_: $("#formbuttonsfile"),			//where do we insert the clone? (target element)
