            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        @if( $recursosdisponiblesproyecto->porcentajeproyecto >= 50 && $recursosdisponiblesproyecto->porcentajeproyecto <=85)
                        <tr>
                            ...
                            <td>  <span class="label label-warning">{{$recursosdisponiblesproyecto->porcentajeproyecto }}%</span></td>
