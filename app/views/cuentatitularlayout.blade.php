            ...
            <ul class="nav navbar-nav side-nav">
                <li>
                    ...
                    <ul id="demo" class="collapse">
                        <li>
                            <a href="{{ URL::to('gestionarsolicitudderecursos/buscarsolicitud') }}">Consultar
                                cuenta colaboradora</a>

                        </li>
                        <li>
                            <a href="{{ URL::to('gestionarsolicitudderecursos/modificarsolicitud') }}">Notificacion de cuenta colaboradora</a>
                        </li>
                ...
                <li>
                    ...
                    <ul id="demo2" class="collapse">
                        ...
                        <li>
                            <a href="{{ URL::to('gestionardependencias/daraltadependecia') }}">Ampliación de
                                recursos</a>
